...
// Generated from Oxford Phrase List.pdf with light cleanup of page headers and obvious wrap artifacts.
// The source PDF was provided locally by the user.
...
const a1Phrases = [
    ...
    'look for sb/sth',
    'look like sb/sth',
    'lots of… millions of… mobile phone',
    'more than… next time',
    'next year',
    'next month',
    'next week',
...
const c1Phrases = [
    ...
    'involvement in sth',
    'let alone',
    'little more than… live on sth',
    'may well',
    'nothing like',
    'not to mention',
    'on behalf of sb',
    'on the part of sb',
    'over the course of… put it',
    'How shall I put it?',
    'seek to do sth',
    'set to do sth',
    'the extent to which…',
